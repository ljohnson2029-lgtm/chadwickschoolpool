      ...
      >
        <div className="p-6 overflow-y-auto">
          ...
          <div className="space-y-6">
            {/* Input Section - High Z-Index to stay on top */}
            ...
            <div className="min-h-[100px] relative z-0">
              {!isAddressValid ? (
        ...
        {/* Footer / Actions */}
        <div className="p-6 bg-muted/30 border-t flex flex-col gap-3 relative z-40 mt-auto">
          <LoadingButton
